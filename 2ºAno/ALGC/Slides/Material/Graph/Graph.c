...
Graph* GraphCopy(const Graph* g) { return 0; }

Graph* GraphFromFile(FILE f) { return 0; }
...
unsigned short GraphCheckInvariants(const Graph* g) {  // TO DO
  return 0;
}
